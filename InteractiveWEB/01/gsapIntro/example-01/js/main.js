...
init();
  ...
  function FUNCTION_mainScrollTrigger() { 
    ...
    .add(FUNCTION_worldTitleDisplayTL,"<") 
  ...
  // The world 애니메이션
  function FUNCTION_worldTitleDisplayTL(){
    
    let titleDisplayTl = gsap.timeline({
      scrollTrigger: {
        trigger: '.theWorldContent',        
        scrub: 0.5,  
        // markers : true,
        // start : "top-=100 80%",
        end : "center center",
    ...
    .to(".titWorld", { y : 0, duration:0.3, opacity : 1 })
    .to(".theWorldContent--textInfo p", { y : 0, duration:0.3, opacity : 1 })
    .add(MENUdarkModeRemove)
    .add(FUNCTION_recruitTitleDisplayTL)
  ...
  function FUNCTION_recruitTitleDisplayTL(){
    ...
    .to(".titRecruit", { y : 0, duration:0.3, opacity : 1 })
    .to(".recruitContent--textInfo p", { y : 0, duration:0.3, opacity : 1 })


    .to(".recruitEarthWrap--earth", { scale:0.8, duration:0.5, } ,"<=+0.3")

    .to(".recruitEarthWrap--imgMainLine1", {  opacity: 0.4, height : 434,  duration : 0.3, },"<+=0.5")
